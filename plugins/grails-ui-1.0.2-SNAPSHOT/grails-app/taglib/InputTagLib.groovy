...
/*                    GRAILSUI.${jsid}.textboxFocusEvent.subscribe(function() {
    ...
    def datePicker = {attrs ->
        ...
        if (attrs.value) {
            ...
            // do this until we get multiple date formatting working
            value = "${d.month}/${d.day}/${d.year} ${d.hour}:${d.minute}:${d.second} ${d.ampm}"
        ...
        if (attrs.remove('includeTime')) {
            ...
            timeTackLogic = """
                ...
                newDateValue += ' ' + hr + ':' + min.pad(2,"0",0) + ':' + sec.pad(2,"0",0) + ' ' + ampm
            """
        }
            ...
            YAHOO.util.Event.onDOMReady(function(){
               ...
               function ${jsid}SelectHandler(){
                if (GRAILSUI.${jsid}.getSelectedDates().length > 0) {
                        ...
                        var newDateValue = mStr +"/"+ dStr   + "/" + yStr;
                        ${timeTackLogic}
